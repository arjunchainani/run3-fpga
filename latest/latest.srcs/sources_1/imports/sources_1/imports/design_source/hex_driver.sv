// ============================================================
//  hex_driver.sv
//  Time-multiplexed driver for a 4-digit hexadecimal display.
//  Converts four 4-bit input nibbles into 7-segment patterns and
//  cycles through the digits so all four values share one display.
//
//  Inputs:
//    clk, reset     - System clock and active-high reset.
//    in[4]          - Four 4-bit hex values, one per display digit.
//
//  Outputs:
//    hex_seg [7:0]  - Active-low segment lines for the current digit.
//    hex_grid [3:0] - Active-low digit-select lines (one hot).
// ============================================================
